...
//public class ImageEditActivity extends ImageBaseActivity implements AdapterView.OnItemClickListener, View.OnClickListener {
...
//    private ArrayList<ImageInfo> mPhotoList;
//    private ImageEditListAdapter mPhotoEditListAdapter;
...
//    private HashMap<String, ImageInfo> mSelectPhotoMap;
...
//                ImageInfo photoInfo = mPhotoList.get(mSelectIndex);
//                try {
...
//        setContentView(R.layout.gf_activity_image_edit);
//
//        mSelectPhotoMap = (HashMap<String, ImageInfo>) this.getIntent().getSerializableExtra(SELECT_MAP);
...
//        mGalleryConfig = ImageHandler.getGalleryConfig();
//
//        if (mPhotoList == null) {
//            mPhotoList = new ArrayList<>();
//        }
//
//        for(ImageInfo info:mPhotoList) {
...
//
//        mPhotoEditListAdapter = new ImageEditListAdapter(this, mPhotoList, mGalleryConfig, mScreenWidth);
...
//
//    @Override
//    protected void takeResult(ImageInfo info) {
//        if (!mGalleryConfig.isMutiSelect()) {
//            mPhotoList.clear();
//        }
//        mPhotoList.add(info);
...
//    }
//
//    private void loadImage(ImageInfo photo) {
...
//    }
//
//    public void deleteIndex(int position, ImageInfo dPhoto) {
//        if (dPhoto != null) {
//            ImageSelectActivity activity = (ImageSelectActivity) ActivityManager.getActivityManager().getActivity(ImageSelectActivity.class.getName());
//            if (activity != null) {
...
//        mSelectIndex = i;
//        ImageInfo photoInfo = mPhotoList.get(i);
//        loadImage(photoInfo);
//    }
//
//    @Override
...
//                }
//            } else { //完成选择
//                ArrayList<ImageInfo> photoList = new ArrayList<>(mSelectPhotoMap.values());
//                Intent intent = getIntent();
//                if (intent == null) {
//                    intent = new Intent();
//                }
//                intent.putExtra(ImageHandler.GALLERY_RESULT_LIST_DATA, photoList);
//                setResult(ImageHandler.EDIT_OK, intent);
//                finish();
//            }
...
//            mRotating = true;
//
//            final ImageInfo photoInfo = mPhotoList.get(mSelectIndex);
//            if (photoInfo != null) {
...
//                        super.onPreExecute();
//                        mTvEmptyView.setVisibility(View.VISIBLE);
//                        mProgressDialog = ProgressDialog.show(ImageEditActivity.this, "", getString(R.string.waiting), true, false);
//                    }
//
//                    @Override
