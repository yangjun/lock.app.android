 ...
 */
public class CirclePageSpaceIndicator extends View implements PageIndicator {
    ...
    public CirclePageSpaceIndicator(Context context) {
        this(context, null);
    }

    public CirclePageSpaceIndicator(Context context, AttributeSet attrs) {
        this(context, attrs, com.viewpagerindicator.R.attr.vpiCirclePageIndicatorStyle);
    }

    public CirclePageSpaceIndicator(Context context, AttributeSet attrs, int defStyle) {
